...
describe('Shape', () => {
  ...
  describe('renderText() method', () => {
    it('should return rendered text element', () => {
      ...
      shape.setText('SVG');
      shape.setTextColor('white');
      expect(shape.renderText()).toBe(`<text x="150" y="120" font-size="80" text-anchor="middle" fill="white">SVG</text>`);
    });
  });
});
...
describe('Triangle', () => {
  ...
  describe('renderShape() method', () => {
    it('should return rendered shape element', () => {
      ...
      expect(triangle.renderShape()).toBe(`<polygon points="150, 0 300, 200 0, 200" fill="blue" />`);
    });
  });
});
...
describe('Circle', () => {
  ...
  describe('renderShape() method', () => {
    it('should return rendered shape element', () => {
      ...
      expect(circle.renderShape()).toBe(`<circle cx="150" cy="100" r="100" fill="blue" />`);
    });
  });
});
...
describe('Square', () => {
  ...
  describe('renderShape() method', () => {
    it('should return rendered shape element', () => {
      ...
      expect(square.renderShape()).toBe(`<rect x="0" y="0" width="300" height="200" fill="blue" />`);
    });
  });
});